...
SECRET_KEY = 'django-insecure-rn%!vrec(qm*^yba1(lyph9vdt%*80i3kprr%z=jhv@56vp#u6'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'accounts', # Added our accounts app
]
...
# Ensure the ContentType for JSON is correctly handled by CORS
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
